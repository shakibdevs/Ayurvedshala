        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
            ...
            <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-emerald-100 h-full flex flex-col">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="relative"><Search className="absolute left-2 top-2.5 text-slate-400" size={16}/><input className="pl-9 p-2 border rounded-lg text-sm w-64 focus:ring-1 focus:ring-emerald-500 outline-none bg-white" placeholder="Search..." value={search} onChange={(e)=>setSearch(e.target.value)}/></div>
                </div>
        ...
        <div className="w-full h-full flex justify-center items-start pt-10">
            <div className="w-full max-w-2xl bg-white p-8 rounded-xl shadow border border-emerald-100">
                ...
                <div className="space-y-4">
                    <input value={localSettings.clinicName} onChange={e=>setLocalSettings({...localSettings, clinicName:e.target.value})} className="w-full p-2 border rounded bg-white" placeholder="Clinic Name"/>
                    <input value={localSettings.doctorName} onChange={e=>setLocalSettings({...localSettings, doctorName:e.target.value})} className="w-full p-2 border rounded bg-white" placeholder="Doctor Name"/>
                    <div className="grid grid-cols-2 gap-4"><input value={localSettings.doctorPwd} onChange={e=>setLocalSettings({...localSettings, doctorPwd:e.target.value})} className="w-full p-2 border rounded bg-white" placeholder="Doctor Pwd"/><input value={localSettings.staffPwd} onChange={e=>setLocalSettings({...localSettings, staffPwd:e.target.value})} className="w-full p-2 border rounded bg-white" placeholder="Staff Pwd"/></div>
                    <div><label className="block text-sm font-bold mb-1">Logo Upload</label><input type="file" onChange={e=>onLogoUpload(e, (data)=>setLocalSettings({...localSettings, logoUrl:data}))} className="w-full p-2 border rounded bg-white"/></div>
